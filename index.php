        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 animation_3 personal_last_block">
                    <?php
                    if (have_posts()) : query_posts('p=15');
                        while(have_posts()) : the_post(); ?>
                    <h3><?php the_title(); ?></h3>
...
<section id="resume" class="s_resume">
    <div class="section_header">
        ...
        <h2><?php $idobj = get_category_by_slug('s_resume');
            $id =$idobj->term_id;
            echo get_cat_name($id); ?></h2>
        <div class="s_descr_wrap">
            <div class="s_descr"><?php echo category_description($id); ?></div>
            ...
            <div class="row">
                <div class="resume_container">
                    ...
                    <div class="col-md-6 col-sm-6 right">
                        ...
                        <div class="resume_icon">
                            <i class="icon-basic-book-pen"></i></div>
...
<section id="portfolio" class="s_portfolio bg_dark">
    <div class="section_header">
        <h2><?php $idobj = get_category_by_slug('s_portfolio');
            $id =$idobj->term_id;
            echo get_cat_name($id); ?></h2>
        <div class="s_descr_wrap">
            <div class="s_descr"><?php echo category_description($id); ?></div>
            ...
            <div class="row">
                <div class="filter_div controls">
                    <ul>
                        ...
                        <li class="filter" data-filter=".aidenty">Айдентика</li>
...
<section id="contacts" class="s_contacts bg_light">
    <div class="section_header">
        <h2><?php $idobj = get_category_by_slug('s_contacts');
            $id =$idobj->term_id;
            echo get_cat_name($id); ?></h2>
        <div class="s_descr_wrap">
            <div class="s_descr"><?php echo category_description($id); ?></div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    <form action="http://formspree.io/supermalcev@yandex.ru" class="main_form" novalidate target="_blank" method="post">
                        ...
                        <label class="form-group">
                            <span class="color_element">*</span> Ваш сообщение:
                            <textarea name="message" placeholder="ваше сообшение" data-validation-required-message="Вы не ввели Сообщение" required ></textarea>
                            <span class="help-block text-danger"></span>
                        </label>
